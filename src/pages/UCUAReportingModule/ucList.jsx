...
const ucReports = [
  ...
  { no: "UC004", date: "08-01-2024 14:20:00", name: "SITI NORAINI", location: "EQUIPMENT ROOM", status: "NEED FEEDBACK" },
];
...
const ucList = () => {
  ...
  const filtered = ucReports.filter((row) =>
